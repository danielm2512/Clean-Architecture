...
namespace Clean_Architecture.Domain.Entities
{
    public sealed class Product : Entity
    {
        ...
        private void ValidateDomain(string name, string description, decimal price, int stock, string image)
        {
            ...
            DomainExecptionValidation.When(string.IsNullOrEmpty(description),
                "Invalid description. Description is required");

            DomainExecptionValidation.When(description.Length < 5,
            ...
            DomainExecptionValidation.When(image?.Length > 250,
